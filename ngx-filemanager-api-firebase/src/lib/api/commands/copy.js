    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    allChildren = _a.sent();
                    return [4 /*yield*/, Promise.all(allChildren.map(function (f) { return storage_helper_1.TryCopyFile(f, oldFolderPrefix_1, newFolderPrefix); }))];
                case 2:
...
exports.copyWithChildren = copyWithChildren;
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    results = translation_helpers_1.getResultFromArray(copyResultsArr);
